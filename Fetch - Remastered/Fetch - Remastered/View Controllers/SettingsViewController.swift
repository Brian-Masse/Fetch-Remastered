...
//    let replay = UIButton()
//    let header = UILabel(frame: CGRect(x: globalScene.width(c: 24), y: 0, width: globalFrame.width, height: globalScene.width(c: 100)))
//
//    let backgroundImage = UIImageView(frame: CGRect(x: 0, y: 0, width: globalFrame.width, height: globalFrame.height))
