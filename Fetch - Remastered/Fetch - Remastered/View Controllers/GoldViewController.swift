...
//    @Published var testInt = 5
//}
//
//struct testView: View {
//
//    @ObservedObject var viewModel: TestClass
//
//    var body: some View {
////        Text("hello world!")
//        Text("\(viewModel.testInt)")
//            .onTapGesture {
//                viewModel.testInt += 1
//            }
//
...
//}
//
////struct test2: UIViewControllerRepresentable {
...
////}
//
//var testViewModel = TestClass()
//var testTestView = testView(viewModel: testViewModel)
//
//let TestViewController = UIHostingController(rootView: testTestView)
//
...
//    let Title = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: 0, width: globalFrame.width, height: globalScene.height(c: 125)))
//    
//    
