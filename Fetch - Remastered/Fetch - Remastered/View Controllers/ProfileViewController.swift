...
//
//    
//    let Title = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: 0, width: globalFrame.width , height: globalScene.height(c: 100)))
//    
//    let CurrentGold = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 120), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let CurrentGold2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 150), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let mostGold = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 220), width: globalFrame.width , height: globalScene.width(c: 50)))
//     let mostGold2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 250), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let farthestThrow = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 320), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let farthestThrow2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 350), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let strength = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 420), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let strength2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 450), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let goldChance = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 520), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let goldChance2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 550), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let goldChance3 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 580), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let friction = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 650), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let friction2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 680), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let ballSkin = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 750), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let ballSkin2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 780), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let dogSkin = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 850), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let dogSkin2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 880), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let discovered = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 950), width: globalFrame.width , height: globalScene.width(c: 50)))
//    let discovered2 = UILabel(frame: CGRect(x: globalScene.width(c: 30), y: globalScene.width(c: 980), width: globalFrame.width , height: globalScene.width(c: 50)))
//    
