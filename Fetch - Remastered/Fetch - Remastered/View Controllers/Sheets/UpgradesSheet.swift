                    ...
                    PixelImage(appearanced( configuration.isPressed ? object.id+"ButtonDown": object.id+"ButtonUp"))
                        ...
                        .overlay(GeometryReader { geo in
                            HStack {
                                ...
                                BouncingText(shouldAnimate: fastestThrowBinding, text: object.maxxed ? "Maxxed!": "\(object.buttonText)", stallTime: 5) { text in UpgradesSheet.constants.createModifierText(object, for: text, in: 20) }
