...
//        titleRect = CGRect(x: globalScene.width(c: 10), y: 0, width: globalFrame.width, height: globalScene.width(c: 100))
//        titelRect2 = CGRect(x: globalScene.width(c: 10), y: globalScene.width(c: 35), width: globalFrame.width, height: globalScene.width(c: 100))
//        titelRect3 = CGRect(x: globalScene.width(c: 10), y: globalScene.width(c: 806), width: globalFrame.width, height: globalScene.width(c: 35))
//        titelRect4 = CGRect(x: globalScene.width(c: 10), y: globalScene.width(c: 1797), width: globalFrame.width, height: globalScene.width(c: 35))
//
//    }
//
