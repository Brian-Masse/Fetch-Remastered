...
//        updateVelocityLabel()
    ...
    func setup() {
        ...
        currentDog = mickey
        virtualCamera = CameraObject(currentBall)
        ...
        rubberBall.position = CGPoint(x: 0, y: 600)
        rubberBall.zPosition = 10000000
        
        
        addChild(currentDog)
        currentDog.zPosition = 1000000
    ...
    func setUpVelocityLabel() {
        if velocityLabel == nil {
            ...
            velocityText.fontName = defaultFont
...
//        }
        ...
        if States.currentState == State.home {
